...
router.post('/generate', auth, adminOnly, async (req, res) => {
  try {
    ...
    const bill = new Bill({
      ...
      dueDate: new Date(dueDate), notes, isAutoGenerated: true
    });
    await bill.save();
...
router.get('/:id/invoice', auth, async (req, res) => {
  try {
    ...
    doc.fontSize(24).font('Helvetica-Bold').text('Radix', 50, 50);
    doc.fontSize(10).font('Helvetica').text('The Root of Reliability', 50, 78);
