    ...
    <div className="animate-fadeIn max-w-2xl">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 mb-6">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div><span className="text-slate-500">Company</span><p className="font-medium text-slate-800 dark:text-white">{user?.company || '-'}</p></div>
          <div><span className="text-slate-500">Customer ID</span><p className="font-medium text-slate-800 dark:text-white">{user?.customerId || '-'}</p></div>
        </div>
      </div>
